...
echo -e "List of updates pending excluding the Kernel and the GLIBC... \n"
echo -e "List of updates pending excluding the Kernel and the GLIBC... " >> $DIR_LOGFILES/update-list.bkp
echo -e "======================================================================================================" >> $DIR_LOGFILES/update-list.bkp
yum check-update | grep -v kernel | grep -v glibc >> $DIR_LOGFILES/update-list.bkp
